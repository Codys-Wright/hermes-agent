...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "NEXTCLOUD_TALK_URL", "NEXTCLOUD_TALK_BOT_SECRET",
    "NEXTCLOUD_TALK_API_USER", "NEXTCLOUD_TALK_API_PASSWORD",
    "NEXTCLOUD_TALK_WEBHOOK_PORT", "NEXTCLOUD_TALK_WEBHOOK_PATH",
    "NEXTCLOUD_TALK_HOME_CHANNEL", "NEXTCLOUD_TALK_AUTO_TEAM", "NEXTCLOUD_TALK_TEAM_ROOM",
...
OPTIONAL_ENV_VARS = {
    ...
    "NEXTCLOUD_TALK_URL": {
        "description": "Nextcloud server URL for Talk bot integration (e.g. https://cloud.example.com)",
        "prompt": "Nextcloud server URL",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "NEXTCLOUD_TALK_BOT_SECRET": {
        "description": "Shared HMAC-SHA256 secret for Nextcloud Talk bot webhook authentication. "
                       "Register a bot in Administration → Talk → Bot management to get this.",
        "prompt": "Bot shared secret (HMAC key)",
        "url": None,
        "password": True,
        "category": "messaging",
    },
    "NEXTCLOUD_TALK_ALLOWED_USERS": {
        "description": "Comma-separated Nextcloud user IDs allowed to interact with the bot",
