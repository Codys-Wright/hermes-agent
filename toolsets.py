...
TOOLSETS = {
    ...
    "hermes-nextcloud-talk": {
        "description": "Nextcloud Talk bot toolset - self-hosted Nextcloud Talk messaging (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
